            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="user_name" id="user_name" class="form-control"
                        placeholder="Enter Your Name" value="<?php echo $_SESSION["customer"] ?>" disabled />
                </div>
                <div class="form-group">
        ...
        $('#save_review').click(function () {
            ...
            if (user_name == '' || user_review == '') {
                ...
                $.ajax({
                    ...
                    method: "POST",
                    data: { rating_data: rating_data, customer_id: customer_id, user_name: user_name, user_review: user_review },
