        ...
        <form action="" method="POST">
            <table class="tbl-full">
                ...
                try {
                    ...
                    $query = "SELECT DISTINCT c.id,f.title,f.price,c.qty,c.total,f.image_name
                          FROM tbl_cart as c
                          JOIN tbl_food as f
                          ON c.food_id = f.id
                          
                         
                          WHERE c.customer_id = $cus_id and c.order_num = $order_num
                    ...
                    if ($count > 0) {
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="failed">Order Is Empty</div>
                            </td>
                        </tr>
