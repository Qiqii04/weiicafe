				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							...
							$query = $conn->query("SELECT * FROM `transaction_data` NATURAL JOIN `guest` NATURAL JOIN `reservation` WHERE `status` = 'Pending'") or die(mysqli_error());
